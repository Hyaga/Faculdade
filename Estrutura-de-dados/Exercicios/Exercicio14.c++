/*Faça um programa que receba o preçp de um produto 
e seu codigo e armazene as informações em uma tabela
hash seguindo a função hash
1 - Sul
2 - Norte 
3 - Leste
5 ou 6 - Nordeste
...
Em seguida o programa deve mostrar quais produtos estao em 
cada uma fas regioes de procedencia*/
